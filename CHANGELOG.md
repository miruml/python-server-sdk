...
Full Changelog: [v0.6.1...v0.7.0](https://github.com/miruml/python-server-sdk/compare/v0.6.1...v0.7.0)
...
* **compat:** update signatures of `model_dump` and `model_dump_json` for Pydantic v1 ([b71ebf9](https://github.com/miruml/python-server-sdk/commit/b71ebf96149950711b88780da4dce30a1e250e02))
* ensure streams are always closed ([ab93bca](https://github.com/miruml/python-server-sdk/commit/ab93bca51d143a6e8d26a05947e538d15ee751ea))
* **types:** allow pyright to infer TypedDict types within SequenceNotStr ([7769f80](https://github.com/miruml/python-server-sdk/commit/7769f807b07bc2d6b611766e1e5d4545289d558d))
* use async_to_httpx_files in patch method ([4c68967](https://github.com/miruml/python-server-sdk/commit/4c6896709773ce6fee0641f107ab0c7364f9716d))


### Chores

* add missing docstrings ([37f1eae](https://github.com/miruml/python-server-sdk/commit/37f1eae5abbe16ad18e05bdf8bfa47509304c7ee))
* add Python 3.14 classifier and testing ([6df3ecd](https://github.com/miruml/python-server-sdk/commit/6df3ecd00b28abb16c06cae6c13b8728445ace6a))
* **deps:** mypy 1.18.1 has a regression, pin to 1.17 ([d644966](https://github.com/miruml/python-server-sdk/commit/d644966063e8b3e17ca407ad4062be2874e07878))
* **docs:** use environment variables for authentication in code snippets ([ee97b11](https://github.com/miruml/python-server-sdk/commit/ee97b11addd6b183e49a28d6ccbc7cb73b9247dd))
...
* **internal:** add `--fix` argument to lint script ([22cd02f](https://github.com/miruml/python-server-sdk/commit/22cd02f5f184a085b365aca7c1f1f6959be0fbcb))
* **internal:** add missing files argument to base client ([1d7820f](https://github.com/miruml/python-server-sdk/commit/1d7820f56b688e75988288e86b2a6eb62657681f))
...
* speedup initial import ([4ebe231](https://github.com/miruml/python-server-sdk/commit/4ebe2315fe940766e2888b4cda52c7d9799e6132))
* update lockfile ([f840597](https://github.com/miruml/python-server-sdk/commit/f8405973872ef23e5294cf061d7794497e15a1ec))


### Refactors

* **api:** change route to be /beta instead of /v1 ([6b7bd87](https://github.com/miruml/python-server-sdk/commit/6b7bd87fd125f8ac6205af2d289e75036df693e4))
