...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/miru.svg?label=pypi%20(stable))](https://pypi.org/project/miru/)
...
pip install git+ssh://git@github.com/stainless-sdks/miru-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install miru`
...
```sh
# install from this staging repo
pip install 'miru[aiohttp] @ git+ssh://git@github.com/stainless-sdks/miru-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/miru-python/tree/main/src/miru/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/miru-python/tree/main/src/miru/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/miru-python/issues) with questions, bugs, or suggestions.
