...
> [!NOTE]
> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install miru_server_sdk`
...
```sh
# install from this staging repo
pip install 'miru_server_sdk[aiohttp] @ git+ssh://git@github.com/stainless-sdks/miru-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/miru-python/tree/main/src/miru_server_sdk/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/miru-python/tree/main/src/miru_server_sdk/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
