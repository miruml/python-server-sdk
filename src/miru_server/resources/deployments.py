...
class DeploymentsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> DeploymentsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/miru-server-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> DeploymentsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/miru-server-python#with_streaming_response
        """
