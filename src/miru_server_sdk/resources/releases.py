...
class ReleasesResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ReleasesResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/mirurobotics/python-server-sdk#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> ReleasesResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/mirurobotics/python-server-sdk#with_streaming_response
        """
