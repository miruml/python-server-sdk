...
class TestMiru:
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = Miru(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = Miru(base_url=base_url, api_key=api_key, _strict_response_validation=False)
...
class TestAsyncMiru:
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncMiru(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = AsyncMiru(base_url=base_url, api_key=api_key, _strict_response_validation=False)
